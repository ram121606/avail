# -*- coding: utf-8 -*-
"""
Created on Fri May 22 17:03:42 2020
...
# maskNet = keras.layers.TFSMLayer('/mask_detector.model')
model_path = "./model/model_detector.model"

# Load the model
maskNet = keras.layers.TFSMLayer(model_path)
